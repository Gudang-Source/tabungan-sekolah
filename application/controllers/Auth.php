...
class Auth extends CI_Controller {
	...
	public function index(){
		...
		$dataWebsite 	=	[
               'title'        =>   'Login Page | Aplikasi Tabungan Sekolah'
          ];
	...
	public function logout(){
     ...
     public function forgot_password(){
		...
		$dataWebsite 	=	[
               'title'        =>   'Lupa Password | Aplikasi Tabungan Sekolah'
          ];
     ...
     public function recovery_password(){
          ...
          if($detailUser->num_rows() >= 1){
               ...
               $this->db->where('idUser', $detailUser->idUser);
               $updatePassword     =    $this->db->update('ts_user', ['password' => md5($passwordBaru)]);
               ...
               if($updatePassword){
                    ...
                    $phpMailer->Port         =    587;
                    $phpMailer->setFrom('sekolahalfarabimedan@falentinodjoka.com', 'Admin Sekolah Al - Farabi Medan');
                    $phpMailer->addAddress($email, $detailUser->nama);
                    $phpMailer->addReplyTo('sekolahalfarabimedan@falentinodjoka.com', 'Admin Sekolah Al - Farabi Medan');
